defmodule OpenAI.AudioTranscription do
  @moduledoc """
  Provides the ability to interact with the OpenAI audio transcription API.

  See the OpenAI audio transcriptions API documentation [here](https://beta.openai.com/docs/api-reference/audio/create).
  """
